...
SELECT C.id as CaseId
      ...
      ,Claims.DemageType as DemageType
      ...
      ,Claims.FranchiseValue as FranchiseValue
      ...
      ,Payables.ActDemageValue as ActDemageValue
...
outer apply (select PT.Reserve from meta.ProgramTypeToClaimTypes as PT where PT.ClaimTypeGID = Claims.TypeGid and PT.ProgramTypeGID = Products.ProgramTypeGid) as Limits
left join (
  SELECT
    CD.CaseGID,
